...
//        ['label' => Html::Icon('star').' '.Yii::t( 'app', 'ข้อมูลทั้งหมด'), 'url' => ['default/all']],
        [
            ...
            'url' => ['#'],
            'items' => [
                ['label' => Html::Icon('plus').' '.Yii::t( 'app', 'เพิ่ม'), 'url' => ['/intercom/intercom/create']],
                ['label' => Html::Icon('list').' '.Yii::t( 'app', 'รายการ'), 'url' => ['/intercom/intercom']],
...
//        ['label' => Html::Icon('folder-open').' '.Yii::t( 'app', 'report'), 'url' => Url::current(), 'options' => ['class' => 'disabled']],
        [
            ...
            'url' => ['#'],
            'items' => [
                ['label' => Html::Icon('briefcase') . ' ' . Yii::t('app', 'ข้อมูลงานในองค์กร'), 'url' => ['/mainjob/']],
                ['label' => Html::Icon('home') . ' ' . Yii::t('app', 'ข้อมูลสถานที่'), 'url' => ['/location/']],
            ]
        ],
